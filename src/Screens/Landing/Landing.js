      ...
      <div className="landing-section">
        <div className="heading-container-mac">
          ...
          <div id="sub-heading-mac">
            SF HACKS CONSTITUTES DIVERGENCE / AN INCLUSIVE PLACE THAT HELPS PEOPLE FIT IN AND FEEL SAFE / WE HELP DISCOVER WHAT
            INNOVATIVE TECHNOLOGY HAS TO OFFER
          </div>
        </div>
  ...
  return (
    <div className="landing-section">
      ...
      <div className="newsletter">
        ...
        <a href="https://sf-hacks-2022.devpost.com/project-gallery" target="_blank" className="newsletter-btn" rel="noreferrer">
          Our Devpost
        </a>
